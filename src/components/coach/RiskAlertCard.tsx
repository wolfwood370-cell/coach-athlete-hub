              ...
              {alerts.map((alert) => (
                <div
                  ...
                  className={cn(
                    ...
                    alert.severity ==="high"                      ?"border-l-2 border-l-destructive"                      :"border-l-2 border-l-warning",
                ...
                >
                  ...
                  {/* Content */}
                  <div
                    className="flex-1 min-w-0 cursor-pointer"                    onClick={() => alert.link && onNavigate(alert.link)}
                  >
                    ...
                    <div className="flex items-center gap-2 mt-0.5">
                      ...
                      <Badge
                        variant="outline"                        className={cn(
                          ...
                          alert.severity ==="high"                            ?"border-destructive/50 text-destructive"                            :"border-warning/50 text-warning"                        )}
                      >
                  ...
                  <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    <Button
                      size="sm"                      variant="outline"                      className="h-8 px-2 text-xs gap-1"                      onClick={(e) => {
                        e.stopPropagation();
                    ...
                    <Button
                      size="icon"                      variant="ghost"                      className="h-8 w-8 text-muted-foreground"                      onClick={(e) => {
                        e.stopPropagation();
                        onDismiss(alert.id);
                      }}
                    >
