    ...
    <>
      <div
        className={cn(
          ...
          completed
            ?"bg-primary/10 ring-1 ring-primary/20"            :"bg-[hsl(var(--m3-surface-container,var(--secondary)))]"        )}
      >
        {/* Set Number */}
        ...
        <div className="relative">
          <Input
            type="number"            inputMode="decimal"            placeholder={targetKg > 0 ? targetKg.toString() :"kg"}
            value={actualKg}
          ...
          {displayWeight > 0 && (
            <Button
              variant="ghost"              size="icon"              className="absolute right-0.5 top-1/2 -translate-y-1/2 h-7 w-7 text-muted-foreground hover:text-primary"              onClick={() => setPlateOpen(true)}
              type="button"            >
        ...
        {/* Reps Input */}
        <Input
          type="number"          inputMode="numeric"          placeholder={targetReps.toString()}
          value={actualReps}
