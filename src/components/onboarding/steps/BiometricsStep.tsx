    ...
    <motion.div
      ...
      <div className="max-w-xl mx-auto space-y-6">
        ...
        <div className="space-y-2">
          ...
          <Input
            id="dob"            type="date"            value={data.dateOfBirth ||''}
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Input
              id="height"              type="number"              placeholder="175"              value={data.heightCm ||''}
          ...
          <div className="space-y-2">
            ...
            <Input
              id="weight"              type="number"              step="0.1"              placeholder="70"              value={data.weightKg ||''}
