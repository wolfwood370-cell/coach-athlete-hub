  ...
  return (
    <div className="relative h-20 w-20">
      <svg
        ...
        <circle
          stroke="hsl(var(--secondary))"          fill="transparent"          strokeWidth={strokeWidth}
          r={normalizedRadius}
          cx={radius}
          cy={radius}
        />
  ...
  return (
    <AthleteLayout>
      <div className="space-y-4 p-4 pb-24">
        ...
        {isDay1 && (
          <motion.div
            ...
            <div className="relative flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
              <Button 
                size="lg"                onClick={() => navigate('/athlete/training')} 
                className="w-full sm:w-auto gap-2 gradient-primary text-primary-foreground"              >
                <Dumbbell className="h-5 w-5"/>
                Primo Allenamento
              </Button>
              <Button 
                size="lg"                variant="outline"                onClick={() => navigate('/athlete/nutrition')} 
        ...
        <motion.div 
          className="relative overflow-hidden rounded-2xl"          initial={{ opacity: 0, y: -10 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <div className="relative p-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="relative">
                  {coachProfile?.logo_url ? (
                    <>
                      <div 
                        className="absolute inset-0 rounded-xl blur-md opacity-40"                        style={{ backgroundColor: coachProfile?.brand_color ||'hsl(var(--primary))'}}
                      />
                      <img 
                        src={coachProfile.logo_url} 
                        alt="Coach"                        className="relative h-10 w-10 rounded-xl object-contain bg-background/80 backdrop-blur-sm border border-border/50"                      />
                    </>
                  ) : (
                    <div 
                      className="h-10 w-10 rounded-xl flex items-center justify-center text-sm font-bold text-white shadow-lg"                      style={{ backgroundColor: coachProfile?.brand_color ||'hsl(var(--primary))'}}
                    >
            ...
            <motion.div 
              className="flex justify-center mt-3"              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
        ...
        <div className="space-y-3">
          ...
          <AnimatePresence mode="wait">
            {!readiness.isCompleted ? (
              <motion.div
                key="readiness-required"                initial={{ opacity: 0, scale: 0.95 }}
                animate={{ opacity: 1, scale: 1 }}
              ...
              >
                ...
                >
                  ...
                  <motion.div 
                    className="absolute inset-0 bg-gradient-to-r from-amber-500/10 to-orange-500/10"                    animate={{ 
                      opacity: [0.3, 0.6, 0.3]
                    }}
                    transition={{ 
                      duration: 2, 
                  ...
                  <CardContent className="relative p-4">
                    <div className="flex items-center gap-4">
                      <motion.div 
                        className="h-14 w-14 rounded-2xl bg-gradient-to-br from-amber-500/30 to-orange-500/20 flex items-center justify-center flex-shrink-0"                        animate={{ 
                          scale: [1, 1.05, 1],
                        }}
                        transition={{ 
                          duration: 2, 
                      ...
                      <Button 
                        size="sm"                        className="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white h-10 px-4 shadow-lg"                      >
              ...
              <motion.div
                key="readiness-complete"                initial={{ opacity: 0, y: -10 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.4 }}
              >
                <Card 
                  className={cn(
                    ...
                    displayLevel ==="high"                      ?"border-emerald-500/30 bg-gradient-to-br from-emerald-500/10 via-emerald-500/5 to-background"                      : displayLevel ==="moderate"                        ?"border-amber-500/30 bg-gradient-to-br from-amber-500/10 via-amber-500/5 to-background"                        :"border-rose-500/30 bg-gradient-to-br from-rose-500/10 via-rose-500/5 to-background"                  )}
                  onClick={handleOpenDrawer}
                >
                  <CardContent className="p-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className={cn(
                          "text-sm font-medium",
                          displayLevel ==="high"?"text-emerald-600 dark:text-emerald-400"                            : displayLevel ==="moderate"?"text-amber-600 dark:text-amber-400"                            :"text-rose-600 dark:text-rose-400"                        )}>
          ...
          >
            {todayWorkout ? (
              <Card 
                ...
                style={{
                  background: canTrain 
                    ?`linear-gradient(135deg, ${coachProfile?.brand_color ||'hsl(var(--primary))'}15, ${coachProfile?.brand_color ||'hsl(var(--primary))'}05)`                    : undefined
                }}
                onClick={() => {
                  if (!canTrain) {
                    handleOpenDrawer();
                ...
                <CardContent className="p-4">
                  <div className="flex items-center gap-4">
                    <div 
                      ...
                      style={canTrain ? { 
                        backgroundColor:`${coachProfile?.brand_color ||'hsl(var(--primary))'}20`                      } : undefined}
                    >
                      <Dumbbell 
                        className="h-7 w-7"                        style={{ color: canTrain ? (coachProfile?.brand_color ||'hsl(var(--primary))') : undefined }}
                      />
                    </div>
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                      ...
                      {canTrain && isLowReadiness && (
                        <motion.div 
                          className="mt-2"                          initial={{ opacity: 0, height: 0 }}
                    ...
                    <Button 
                      ...
                      style={canTrain ? { 
                        background:`linear-gradient(135deg, ${coachProfile?.brand_color ||'hsl(var(--primary))'}, ${coachProfile?.brand_color ||'hsl(var(--primary))'}dd)`                      } : undefined}
                      disabled={!canTrain}
                      onClick={(e) => {
                        e.stopPropagation();
                        if (!canTrain) {
              ...
              <Card className="border-0 bg-gradient-to-br from-emerald-500/10 to-teal-500/5 border border-emerald-500/20">
                <CardContent className="p-5 text-center">
                  <motion.div 
                    className="inline-flex items-center justify-center h-14 w-14 rounded-full bg-emerald-500/15 mb-3"                    animate={{ 
                      scale: [1, 1.05, 1]
                    }}
                    transition={{ 
                      duration: 4, 
                    ...
                    {habits.map((habit, index) => (
                      <motion.button
                        ...
                        className={cn(
                          ...
                          "active:scale-[0.98]",
                          habit.isCompleted 
                            ?"bg-success/10 border border-success/20"                            :"bg-secondary/50 hover:bg-secondary/70 border border-transparent"                        )}
                      ...
                      >
                        <motion.div 
                          className={cn(
                            ...
                            habit.isCompleted 
                              ?"bg-success"                              :"border-2 border-muted-foreground/30"                          )}
          ...
          <div className="mx-auto w-full max-w-md overflow-y-auto">
            ...
            <DrawerFooter className="pt-2">
              <Button 
                ...
                className="w-full h-12 font-semibold gradient-primary"                disabled={isSaving}
              >
