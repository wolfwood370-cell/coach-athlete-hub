    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 px-6 pt-6 flex flex-col gap-6 max-w-md mx-auto pb-40 w-full">
        ...
        {tab === "diario" ? (
          ...
          <section className="bg-white/70 backdrop-blur-xl border border-surface-variant/50 rounded-2xl p-8 shadow-sm text-center">
            <h2 className="font-display text-xl font-bold text-primary tracking-tight mb-2">
              Strategia Nutrizionale
            </h2>
            <p className="text-sm text-on-surface-variant">
              La tua strategia personalizzata sarà disponibile a breve.
            </p>
          </section>
        )}
      </main>
