...
-- Create analytics view aggregating workout data per athlete per day
CREATE OR REPLACE VIEW public.analytics_athlete_progress AS
SELECT
  wl.athlete_id,
...
-- Enable realtime on workout_logs so coach sees live updates
